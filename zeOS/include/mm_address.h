...
// FUERA DEL CODIGO (ME ASEGURO QUE NO ESTEN SIENDO USADAS)
#define PAG_LOG_AFTER_CODE (PAG_LOG_INIT_CODE+NUM_PAG_CODE)
#define L_AFTER_CODE (PAG_LOG_AFTER_CODE<<12)
/* Memory distribution */
/***********************/
